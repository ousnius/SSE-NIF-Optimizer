...
public:
	...
	Optimizer(wxWindow* parent, wxWindowID id = wxID_ANY, const wxString& title = "SSE NIF Optimizer v3.0.11", const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxSize(475, 340), long style = wxDEFAULT_FRAME_STYLE | wxTAB_TRAVERSAL);
	~Optimizer();
